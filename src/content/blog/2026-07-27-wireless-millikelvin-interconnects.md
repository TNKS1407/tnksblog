...
それと、無線にすれば熱が消える、という話でもない。同軸ケーブルが持ち込む熱の主役は熱伝導で、室温側と冷たい側を金属で物理的に繋いでしまうこと自体が問題なんだ。無線化が断とうとしているのはそこであって、電磁波を使う側にも発熱源は残る。アンテナや基板の誘電損失、送受信回路そのものの消費電力、そして吸収された電磁波は最後には熱になる。最冷ステージで使える冷却パワーは先に書いたとおり数十マイクロワットのオーダーだから、ミリワット級の回路をそこに置くことはできない。だから現実的には「全部を無線に」ではなく、どの温度ステージに何を置くかという配分の問題になるんだろうと思う。
