...
- [XFreq-GS: Cross-Frequency Wireless Radiation Field Reconstruction with 3D Gaussian Splatting（arXiv:2605.11432）](https://arxiv.org/abs/2605.11432)（本記事で紹介した論文）
- [WRF-GS: Wireless Radiation Field Reconstruction with 3D Gaussian Splatting（arXiv:2412.04832）](https://arxiv.org/abs/2412.04832)（単一周波数の先行研究。XFreq-GS が拡張した土台にあたる）
- [WRF-GS 参照実装（GitHub）](https://github.com/wenchaozheng/WRF-GS)

性能比較は論文中の実験に基づくよ。「既存手法を上回る」というのは著者らの評価条件下での結果なので、適用先によって差は変わりうる、という前提で読むのがいいと思う。
